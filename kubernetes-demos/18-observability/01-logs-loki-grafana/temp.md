...
**03-loki-configmap.yaml** stores the Loki configuration file as a ConfigMap
key. This is the most important file to understand — it controls every aspect
of Loki's behaviour.
...
**05-grafana-datasources-cm.yaml** provides the datasource definition:
```yaml
...
**06-grafana-dashboard-cm.yaml** embeds a Grafana dashboard as JSON.
...
### Step 8: Update Fluent Bit ConfigMap — Connect to Loki
...
**08-fluent-bit-configmap-loki.yaml** replaces the ConfigMap from Lab 03:
...
### Step 9: Verify Logs Are Reaching Loki
...
### Step 10: Explore Logs in Grafana — Explore Mode
...
### Step 11: Use the Kubernetes Logs Dashboard
...
### Step 12: Verify the Multi-Cluster Label Design
...
### Step 13: Create an Alert Rule — Log Error Rate
